...
const smileys: readonly EmojiEntry[] = [
  ...
  { emoji: '🤐', keywords: ['zipper', 'quiet', 'sealed'] },
...
const people: readonly EmojiEntry[] = [
  ...
  { emoji: '🤩', keywords: ['star', 'eyes', 'starstruck'] },
  { emoji: '🤥', keywords: ['lying', 'pinocchio'] },
  { emoji: '😯', keywords: ['hushed', 'surprised', 'gasp'] },
  { emoji: '🤫', keywords: ['shush', 'quiet', 'secret'] },
  { emoji: '🤔', keywords: ['think', 'hmm'] },
  { emoji: '🤪', keywords: ['zany', 'goofy', 'crazy'] },
  { emoji: '🤗', keywords: ['hug'] },
...
const symbols: readonly EmojiEntry[] = [
  ...
  { emoji: '💋', keywords: ['kiss', 'lips', 'smooch'] },
